...
const Homepage: React.FC = () => {
          ...
          icon: (
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M17 20h5v-2a4.978 4.978 0 00-4-4.899M9 20H4v-2a4 4 0 014-4h.607M15 7a4 4 0 11-8 0 4 4 0 018 0z"
              />
            </svg>
          ),
        },
  ...
  const benefits = [
    {
      icon: <Route className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />,
      title: "Resort Shuttle Service",
      desc: "Pick-up & drop from nearby bus stations",
    },
    {
      icon: <Mountain className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />,
      title: "Trekking Trails Access",
      desc: "Direct trails to Kolli Hills viewpoints",
    },
    {
      icon: <Bus className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />,
      title: "Local Bus Connection",
      desc: "Frequent buses from Namakkal & nearby towns",
    },
    {
      icon: <Map className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />,
      title: "Nearby Attractions",
      desc: "Puliancholai, Vasalurpatty, Seeku Parai within 15–20 min",
    },
  ];
        ...
        <div className="relative z-10 flex flex-col justify-center items-start h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fadeIn delay-400 w-full sm:w-auto">
            <button
              ...
              className="px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 font-semibold rounded-lg hover:bg-blue-700 transition text-sm sm:text-base w-full sm:w-auto">
              Book Now
            </button>
            <button
          ...
          <div className="flex flex-col lg:flex-row gap-4 md:gap-6 mb-6 md:mb-10">
            ...
            <div className="flex flex-col gap-4 w-full lg:w-[315px]">
              {rooms.map((room) => (
                ...
                >
                  {/* Dynamic image path based on title */}
                  <img
                    src={Garden}
                    alt={room.name}
                  ...
                  <div className="p-3 sm:p-4 flex-1 flex flex-col">
                    ...
                    <div className="flex flex-wrap gap-2 my-2">
                      {room.features.map((f) => (
                        <span
                          key={f.label}
                          className="inline-flex items-center gap-1 text-gray-600 bg-gray-100 rounded-full px-2 py-0.5 text-[11px] sm:text-xs"
                        >
                          {f.icon}
                          {f.label}
                        </span>
                    ...
                    <button
                      onClick={() => navigate("/booking")}
                      className="mt-auto py-1.5 px-3 rounded-lg bg-blue-600 text-white text-xs sm:text-sm font-semibold hover:bg-blue-800 transition"
                    >
                      Book
                    </button>
                  </div>
              ...
              >
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  ...
                  <button
                    ...
                    className="w-full py-2.5 sm:py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
                    Book Now
                  </button>
                </div>
              </div>
