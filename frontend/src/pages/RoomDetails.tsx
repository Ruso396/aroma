      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="relative">
            <span className="absolute top-4 left-4 bg-teal-700 text-white px-3 py-1 rounded text-sm font-medium z-10">
              Popular Suite
            </span>
            <img
              src={mainImage}
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-teal-700 text-white px-2 py-1 text-xs font-bold rounded">4.8</span>
        ...
        {/* Bottom CTA */}
        <section className="bg-teal-900 text-white p-8 rounded-lg flex justify-between items-center">
          <div>
